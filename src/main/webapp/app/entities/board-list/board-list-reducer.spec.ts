...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOARDLIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOARDLIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOARDLIST actions', async () => {
      const arg = { id: 20980 };
    ...
    it('dispatches UPDATE_BOARDLIST actions', async () => {
      const arg = { id: 20980 };
    ...
    it('dispatches PARTIAL_UPDATE_BOARDLIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOARDLIST actions', async () => {
      const arg = 42666;
