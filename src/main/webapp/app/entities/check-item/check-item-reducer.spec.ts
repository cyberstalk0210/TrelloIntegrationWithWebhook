...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHECKITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHECKITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHECKITEM actions', async () => {
      const arg = { id: 31760 };
    ...
    it('dispatches UPDATE_CHECKITEM actions', async () => {
      const arg = { id: 31760 };
    ...
    it('dispatches PARTIAL_UPDATE_CHECKITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHECKITEM actions', async () => {
      const arg = 42666;
