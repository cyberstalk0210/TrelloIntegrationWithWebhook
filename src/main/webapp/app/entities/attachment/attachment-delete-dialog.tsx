...
export const AttachmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="trilloIntegrationApp.attachment.delete.question">
        <Translate contentKey="trilloIntegrationApp.attachment.delete.question" interpolate={{ id: attachmentEntity.id }}>
