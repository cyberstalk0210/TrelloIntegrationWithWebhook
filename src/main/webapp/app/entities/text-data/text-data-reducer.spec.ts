...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './text-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEXTDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TEXTDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TEXTDATA actions', async () => {
      const arg = { id: 29415 };
    ...
    it('dispatches UPDATE_TEXTDATA actions', async () => {
      const arg = { id: 29415 };
    ...
    it('dispatches PARTIAL_UPDATE_TEXTDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TEXTDATA actions', async () => {
      const arg = 42666;
