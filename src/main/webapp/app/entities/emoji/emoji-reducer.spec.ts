...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './emoji.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMOJI_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMOJI actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMOJI actions', async () => {
      const arg = { id: 27088 };
    ...
    it('dispatches UPDATE_EMOJI actions', async () => {
      const arg = { id: 27088 };
    ...
    it('dispatches PARTIAL_UPDATE_EMOJI actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMOJI actions', async () => {
      const arg = 42666;
