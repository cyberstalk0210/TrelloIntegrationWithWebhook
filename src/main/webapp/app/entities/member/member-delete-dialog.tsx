...
export const MemberDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="trilloIntegrationApp.member.delete.question">
        <Translate contentKey="trilloIntegrationApp.member.delete.question" interpolate={{ id: memberEntity.id }}>
