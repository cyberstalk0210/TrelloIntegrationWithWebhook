...
export const CommentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="trilloIntegrationApp.comment.delete.question">
        <Translate contentKey="trilloIntegrationApp.comment.delete.question" interpolate={{ id: commentEntity.id }}>
