...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './board.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOARD actions', async () => {
      const arg = { id: 22306 };
    ...
    it('dispatches UPDATE_BOARD actions', async () => {
      const arg = { id: 22306 };
    ...
    it('dispatches PARTIAL_UPDATE_BOARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOARD actions', async () => {
      const arg = 42666;
