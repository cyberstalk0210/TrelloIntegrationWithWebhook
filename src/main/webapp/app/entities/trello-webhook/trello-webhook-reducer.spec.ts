...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRELLOWEBHOOK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRELLOWEBHOOK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRELLOWEBHOOK actions', async () => {
      const arg = { id: 19561 };
    ...
    it('dispatches UPDATE_TRELLOWEBHOOK actions', async () => {
      const arg = { id: 19561 };
    ...
    it('dispatches PARTIAL_UPDATE_TRELLOWEBHOOK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRELLOWEBHOOK actions', async () => {
      const arg = 42666;
