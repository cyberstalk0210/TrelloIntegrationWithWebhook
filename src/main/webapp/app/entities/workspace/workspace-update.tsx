  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="trilloIntegrationApp.workspace.home.createOrEditLabel" data-cy="WorkspaceCreateUpdateHeading">
            <Translate contentKey="trilloIntegrationApp.workspace.home.createOrEditLabel">Create or edit a Workspace</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('trilloIntegrationApp.workspace.name')}
                id="workspace-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('trilloIntegrationApp.workspace.trelloId')}
                id="workspace-trelloId"
                name="trelloId"
                data-cy="trelloId"
                type="text"
                validate={{
