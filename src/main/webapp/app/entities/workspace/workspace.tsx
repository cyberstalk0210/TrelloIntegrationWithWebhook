  ...
  return (
    <div>
      <h2 id="workspace-heading" data-cy="WorkspaceHeading">
        <Translate contentKey="trilloIntegrationApp.workspace.home.title">Workspaces</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="trilloIntegrationApp.workspace.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/workspace/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="trilloIntegrationApp.workspace.home.createLabel">Create new Workspace</Translate>
          </Link>
        </div>
      </h2>
        ...
        {workspaceList && workspaceList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="trilloIntegrationApp.workspace.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="trilloIntegrationApp.workspace.name">Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                <th className="hand" onClick={sort('trelloId')}>
                  <Translate contentKey="trilloIntegrationApp.workspace.trelloId">Trello Id</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="trilloIntegrationApp.workspace.home.notFound">No Workspaces found</Translate>
            </div>
          )
        )}
      </div>
