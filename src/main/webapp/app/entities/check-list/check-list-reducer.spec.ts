...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHECKLIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHECKLIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHECKLIST actions', async () => {
      const arg = { id: 15108 };
    ...
    it('dispatches UPDATE_CHECKLIST actions', async () => {
      const arg = { id: 15108 };
    ...
    it('dispatches PARTIAL_UPDATE_CHECKLIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHECKLIST actions', async () => {
      const arg = 42666;
