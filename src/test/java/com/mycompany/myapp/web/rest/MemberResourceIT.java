...
class MemberResourceIT {
    ...
    public static Member createEntity() {
        return new Member().trelloId(DEFAULT_TRELLO_ID).name(DEFAULT_NAME);
    }
    ...
    public static Member createUpdatedEntity() {
        return new Member().trelloId(UPDATED_TRELLO_ID).name(UPDATED_NAME);
    }
    ...
    void putExistingMember() throws Exception {
        ...
        updatedMember.trelloId(UPDATED_TRELLO_ID).name(UPDATED_NAME);
    ...
    void partialUpdateMemberWithPatch() throws Exception {
        ...
        partialUpdatedMember.name(UPDATED_NAME);
    ...
    void fullUpdateMemberWithPatch() throws Exception {
        ...
        partialUpdatedMember.trelloId(UPDATED_TRELLO_ID).name(UPDATED_NAME);
