...
class CommentResourceIT {
    ...
    public static Comment createEntity() {
        return new Comment().author(DEFAULT_AUTHOR).text(DEFAULT_TEXT).createdAt(DEFAULT_CREATED_AT);
    }
    ...
    public static Comment createUpdatedEntity() {
        return new Comment().author(UPDATED_AUTHOR).text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT);
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.author(UPDATED_AUTHOR).text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.author(UPDATED_AUTHOR).text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT);
