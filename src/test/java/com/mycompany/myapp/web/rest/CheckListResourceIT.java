...
class CheckListResourceIT {
    ...
    private static final String DEFAULT_CHECK_LIST_ID = "AAAAAAAAAA";
    private static final String UPDATED_CHECK_LIST_ID = "BBBBBBBBBB";
    ...
    public static CheckList createEntity() {
        return new CheckList().checkListId(DEFAULT_CHECK_LIST_ID).name(DEFAULT_NAME);
    }
    ...
    public static CheckList createUpdatedEntity() {
        return new CheckList().checkListId(UPDATED_CHECK_LIST_ID).name(UPDATED_NAME);
    }
    ...
    void getAllCheckLists() throws Exception {
        ...
        restCheckListMockMvc
            ...
            .andExpect(jsonPath("$.[*].checkListId").value(hasItem(DEFAULT_CHECK_LIST_ID)))
    ...
    void getCheckList() throws Exception {
        ...
        restCheckListMockMvc
            ...
            .andExpect(jsonPath("$.checkListId").value(DEFAULT_CHECK_LIST_ID))
    ...
    void putExistingCheckList() throws Exception {
        ...
        updatedCheckList.checkListId(UPDATED_CHECK_LIST_ID).name(UPDATED_NAME);
    ...
    void partialUpdateCheckListWithPatch() throws Exception {
        ...
        partialUpdatedCheckList.checkListId(UPDATED_CHECK_LIST_ID).name(UPDATED_NAME);
